...
const initialAlerts: Alert[] = [
  {
    ...
    description: "Quedas de energia intermitentes no bloco de fisioterapia. Várias salas ficando sem energia por períodos de 10-15 minutos.",
    location: "Bloco de fisioterapia",
  ...
  },
  {
    ...
    description: "Várias lâmpadas queimadas no estacionamento ao redor da reitoria, causando pontos escuros que comprometem a segurança.",
    location: "Estacionamento de reitoria",
    createdBy: "Admin Sistema",
